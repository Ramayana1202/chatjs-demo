/****** Object:  Table [dbo].[__MigrationHistory]    Script Date: 21/04/2014 17:38:07 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[ChatConversation]    Script Date: 21/04/2014 17:38:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ChatMessage]    Script Date: 21/04/2014 17:38:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ChatRoom]    Script Date: 21/04/2014 17:38:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ChatRoomUsers]    Script Date: 21/04/2014 17:38:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ChatUserConversations]    Script Date: 21/04/2014 17:38:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[User]    Script Date: 21/04/2014 17:38:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UserClaims]    Script Date: 21/04/2014 17:38:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UserLogins]    Script Date: 21/04/2014 17:38:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UserRoles]    Script Date: 21/04/2014 17:38:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Index [IX_RoomId]    Script Date: 21/04/2014 17:38:07 ******/
...
GO
/****** Object:  Index [IX_UserFromId]    Script Date: 21/04/2014 17:38:07 ******/
CREATE NONCLUSTERED INDEX [IX_UserFromId] ON [dbo].[ChatMessage]
(
	[UserFromId] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, DROP_EXISTING = OFF, ONLINE = OFF)
GO
/****** Object:  Index [IX_UserToId]    Script Date: 21/04/2014 17:38:07 ******/
...
GO
/****** Object:  Index [IX_UserId]    Script Date: 21/04/2014 17:38:07 ******/
CREATE NONCLUSTERED INDEX [IX_UserId] ON [dbo].[ChatRoomUsers]
(
	[UserId] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, DROP_EXISTING = OFF, ONLINE = OFF)
GO
/****** Object:  Index [IX_ConversationId]    Script Date: 21/04/2014 17:38:07 ******/
